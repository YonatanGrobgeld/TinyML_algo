...
**Report notes:** A report-ready summary of the implementation (algorithm, dataset, hardware extensions, verification, and reproducibility) is in [REPORT_NOTES_IMPLEMENTATION.md](REPORT_NOTES_IMPLEMENTATION.md).

### Final measured speedup (Nexys4DDR @ 100 MHz)

All three modes measured on the **same FPGA bitstream**, with `ENC_CKSUM` bit-identical across modes (correctness verified):
