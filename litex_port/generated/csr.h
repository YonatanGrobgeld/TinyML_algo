 ...
 *  SAMPLE of the LiteX AUTO-GENERATED 'phonebook' of the SoC: the address of every
 *  peripheral register (uart, timer0, gemv, exp_lut...) plus tiny accessor functions like
 *  timer0_value_read() or gemv_x_in_write(). The REAL file comes from the separate LiteX
 *  SoC build tree; this copy is checked in for reference so the repo is self-contained.
 *  BIG PICTURE: This is how C code finds the hardware: names -> addresses.
 * ==========================================================================
 */
